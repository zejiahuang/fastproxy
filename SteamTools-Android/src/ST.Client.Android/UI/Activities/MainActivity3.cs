...
{
    /// <summary>
    /// 使用 ViewPager2 + NavigationBarView 实现的 MainActivity
    /// </summary>
    ...
    internal sealed partial class MainActivity : BaseActivity<activity_main_3>, ViewPagerAdapter.IHost, NavigationBarView.IOnItemSelectedListener
    {
