...
using AsyncLock = System.Threading.SemaphoreSlim;
...
namespace System.Application.Services.Implementation
{
    public sealed class HttpServiceImpl : GeneralHttpClientFactory, IHttpService
    {
        ...
        readonly AsyncLock lockGetImageLocalFilePathAsync = new(1, 1);
        ...
        public async Task<string?> GetImageLocalFilePathAsync(string requestUri, string channelType, CancellationToken cancellationToken)
        {
            ...
            await lockGetImageLocalFilePathAsync.WaitAsync(cancellationToken);
            try
            {
            ...
            {
                lockGetImageLocalFilePathAsync.Release();
            }
